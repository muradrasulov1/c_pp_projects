...
//  hw08.cpp
//
//  Created by Murad on 30.04.22.
//

// The program creates polynomial instances, where each term can be zero, non-zero,
// and degrees are implemented.Polynomial is built using built-in private node class.
// Each node has next term and coefficient parametres. Each term is analyzed for the
// output operator to avoid tautology like x^1, 1x^2, or 5x^0
// Linked Lists, Operator Overloading, Copy control and Separate compilation were used.
